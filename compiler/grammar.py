...
quoted_string_value = \
	QuotedString('"', escChar='\\', unquoteResults = False, multiline=True, convertWhitespaceEscapes=False) | \
	QuotedString("'", escChar='\\', unquoteResults = False, multiline=True, convertWhitespaceEscapes=False) | \
	QuotedString("`", escChar='\\', unquoteResults = False, multiline=True, convertWhitespaceEscapes=False)
...
unquoted_string_value = \
	QuotedString('"', escChar='\\', unquoteResults = True, multiline=True, convertWhitespaceEscapes=False) | \
	QuotedString("'", escChar='\\', unquoteResults = True, multiline=True, convertWhitespaceEscapes=False) | \
	QuotedString("`", escChar='\\', unquoteResults = True, multiline=True, convertWhitespaceEscapes=False)
